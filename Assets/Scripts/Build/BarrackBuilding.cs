...
public class BarrackBuilding : Building
{
    ...
    protected override void OnEmpty ( )
    {
        ...
        MonoSingleton<GameManager>.Instance.GameMode.OnMessageBox ( noticeMsg, true, BuildOK, leftMsg, true, null, "아니요" );
    }

    protected override void OnWork ( )
    {
        string noticeMsg = string.Format ( "아직 {0}가 지어지지않았습니다.", msg );
        MonoSingleton<GameManager>.Instance.GameMode.OnMessageBox ( noticeMsg, true, null, "확인" );
    }
